...
class GeneralSettingController extends Controller
{
    ...
    {
        $request->validate([
            'logo' => ['required', 'max:5000', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
            'footer_logo' => ['required', 'max:5000', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
            'favicon' => ['required', 'max:5000', 'image', 'mimes:jpeg,png,jpg,gif,svg'],
        ]);
